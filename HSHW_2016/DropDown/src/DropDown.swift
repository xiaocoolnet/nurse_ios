...
public final class DropDown: UIView {
	...
	*/
	public dynamic var cornerRadiu = DPDConstant.UI.CornerRadius {
		willSet {
...
private extension DropDown {
	...
	func setupUI() {
		...
		tableViewContainer.layer.cornerRadius = cornerRadiu
		...
		tableView.layer.cornerRadius = cornerRadiu
