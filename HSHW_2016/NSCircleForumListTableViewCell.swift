...
class NSCircleForumListTableViewCell: UITableViewCell {
    ...
    func setCellWithNewsInfo(forum:ForumModel) {
        ...
        attrStr.appendAttributedString(NSAttributedString(string: "儿科", attributes: [NSForegroundColorAttributeName:COLOR]))
