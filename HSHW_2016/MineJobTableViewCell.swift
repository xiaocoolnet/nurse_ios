...
//        btnTit.font = UIFont.systemFontOfSize(12)
        ...
        location.frame = CGRectMake(WIDTH*95/375+28+time.bounds.size.width, content.frame.size.height+content.frame.origin.y, 70, 10)
        ...
        let line = UILabel(frame: CGRectMake(0, 164.5, WIDTH, 0.5))
