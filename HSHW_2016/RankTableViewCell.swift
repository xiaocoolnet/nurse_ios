...
class RankTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        scoreImg.frame = CGRectMake(CGRectGetMaxX(indexBtn.frame)+22/750.0*WIDTH, 55/1380.0*HEIGHT-37/1500*WIDTH, 37/750*WIDTH, 37/750*WIDTH)
        self.contentView.addSubview(scoreImg)
        
        nameLab.frame = CGRectMake(CGRectGetMaxX(scoreImg.frame)+3/750.0*WIDTH, 35/1380.0*HEIGHT, 128/750.0*WIDTH, 35/1380.0*HEIGHT)
        nameLab.textColor = UIColor(red: 51/255.0, green: 51/255.0, blue: 51/255.0, alpha: 1)
        nameLab.font = UIFont.systemFontOfSize(18)
        nameLab.textAlignment = .Left
        self.contentView.addSubview(nameLab)
        
        scoreLab.frame = CGRectMake(CGRectGetMaxX(nameLab.frame), CGRectGetMinY(nameLab.frame), 315/750.0*WIDTH, 3/138.0*HEIGHT)
        ...
        timeLab.frame = CGRectMake(CGRectGetMaxX(nameLab.frame), CGRectGetMaxY(scoreLab.frame), 315/750.0*WIDTH, 18/1380.0*HEIGHT)
