//
//  NSCircleSearchResultViewController.swift
//  HSHW_2016
//
...
class NSCircleSearchResultViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        BaiduMobStat.default().pageviewStart(withName: "护士站 圈子 \((self.title ?? "搜索结果"))")
    }
    
    override func viewDidDisappear(_ animated: Bool) {
        super.viewDidDisappear(animated)
        
        BaiduMobStat.default().pageviewEnd(withName: "护士站 圈子 \((self.title ?? "搜索结果"))")
    }
