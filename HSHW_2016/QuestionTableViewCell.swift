...
class QuestionTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        let zanImage = UIButton(frame: CGRectMake(WIDTH-55, 21, 10, 10))
        zanImage.setImage(UIImage(named: "ic_eye_purple.png"), forState: .Normal)
        zanNum.frame = CGRectMake(WIDTH-40, 18, 35, 18)
        zanNum.font = UIFont.systemFontOfSize(10)
        zanNum.textColor = UIColor.grayColor()
        let conImage = UIButton(frame: CGRectMake(WIDTH-55, 21, 10, 10))
        conImage.setImage(UIImage(named: "ic_eye_purple.png"), forState: .Normal)
