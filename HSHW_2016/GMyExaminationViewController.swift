    ...
    func createScrollerView_1() {
        ...
        for  i in 0 ..< self.dataSource.count {
            ...
            for j in 0 ..< examInfo.answers.count {
                ...
                let chara:Character = Character(UnicodeScalar(asc))
                string.append(chara)
                btn.setTitle(string+"、"+answerInfo.title, forState: .Normal)
                var AllHeight = CGFloat()
                AllHeight = CGFloat(heightArray.lastObject as! NSNumber)
                contentScrollView.contentSize = CGSizeMake(WIDTH-20, AllHeight+10*CGFloat(examInfo.answers.count-1))
            }
    ...
    func createScrollerView_2() {
        ...
        for  i in 0 ..< self.dataSource.count {
            ...
            for j in 0 ..< examInfo.answers_2.count {
                ...
                var AllHeight = CGFloat()
                AllHeight = CGFloat(heightArray.lastObject as! NSNumber)
                contentScrollView.contentSize = CGSizeMake(WIDTH-20, AllHeight+10*CGFloat(examInfo.answers_2.count-1))
            }
